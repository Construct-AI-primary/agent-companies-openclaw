...
# ⚠️ TOKEN REDACTED — Set DISCORD_BOT_TOKEN environment variable before running
# Get your token from: https://discord.com/developers/applications > Bot > Reset Token
BOT_TOKEN="${DISCORD_BOT_TOKEN:-YOUR_BOT_TOKEN_HERE}"
...
cat > package.json << 'PKGJSON'
{
  ...
  "version": "3.0.0",
  "description": "OpenClaw Discord Bot — Channel-based agent communication",
  "main": "bot.js",
  "scripts": {
    "start": "node bot.js",
...
echo ""
echo "=== How It Works ==="
echo "1. Humans type directly in any agent channel"
echo "2. Bot acknowledges and forwards to the agent"
echo "3. Agent replies in the same channel"
echo "4. No commands needed — just type and receive"